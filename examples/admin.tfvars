...
# Expose ECLWatch and elastic4hpcclogs to the internet. This can be unsafe and may not be supported by your organization. 
...
# Automatically connect to the kubernetes cluster from the host machine.
auto_connect = true

# Disable Helm deployments by Terraform. This is reserved for experimentation with other deployment tools like Flux2.
# disable_helm = false 

# Disable naming conventions
# disable_naming_conventions = true 

# Automatically launch ECLWatch web interface.
...
/*
  # Provide an existing virtual network that was deployed outside of this project
  virtual_network = {
...
registry = {
  password = "my_api_key"
  server   = "westus.blackgirlscode.com"
  username = "shuri@blackgirlscode.com"
}
