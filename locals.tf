locals {
  ...
  resource_group  = { location = var.storage.default ? var.resource_group.location : try(var.storage.storage_account.location, data.azurerm_storage_account.hpccsa[0].location) }
